...
f.length;g++)d=f[g],d.setCascadeRegen(!1);this.regenerating=!1;if(c!==e){e=0;for(c=this.s.panes;e<c.length;e++)d=c[e],d.s.forceViewTotal=!1}};n.prototype._checkMessage=function(){for(var a=0,b=this.s.panes;a<b.length;a++)if(!0===b[a].s.displayed){j(this.dom.emptyMessage).remove();return}return this._attachMessage()};n.prototype._getState=function(){var a=this.s.dt.state.loaded();a&&(a.searchPanes&&void 0!==a.searchPanes.selectionList)&&(this.s.selectionList=a.searchPanes.selectionList)};n.prototype._makeCascadeSelections=
function(a){for(var b=0;b<a.length;b++)for(var e=function(d){if(d.s.index===a[b].index&&void 0!==d.s.dtPane){b===a.length-1&&(d.s.lastCascade=!0);0<d.s.dtPane.rows({selected:!0}).data().toArray().length&&void 0!==d.s.dtPane&&(d.setClear(!0),d.clearPane(),d.setClear(!1));for(var e=function(a){var b=false;d.s.dtPane.rows().every(function(c){if(d.s.dtPane.row(c).data()!==void 0&&a!==void 0&&d.s.dtPane.row(c).data().filter===a.filter){b=true;d.s.dtPane.row(c).select()}});b||d.addRow(a.display,a.filter,
0,a.total,a.sort,a.type,a.className).select()},g=0,h=a[b].rows;g<h.length;g++)e(h[g]);d.s.dtPane.draw();c._updateFilterCount();d.s.lastCascade=!1}},c=this,g=0,d=this.s.panes;g<d.length;g++)e(d[g]);this.s.dt.state.save()};n.prototype._paneDeclare=function(a,b,e){var c=this;a.columns(0<this.c.columns.length?this.c.columns:void 0).eq(0).each(function(a){c.s.panes.push(new t(b,e,a,c.c.layout,c.dom.panes))});for(var g=a.columns().eq(0).toArray().length,d=this.c.panes.length,f=0;f<d;f++)this.s.panes.push(new t(b,
e,g+f,this.c.layout,this.dom.panes,this.c.panes[f]));if(0<this.c.order.length){g=this.c.order.map(function(a){return c._findPane(a)});this.dom.panes.empty();this.s.panes=g;g=0;for(d=this.s.panes;g<d.length;g++)this.dom.panes.append(d[g].dom.container)}this.s.dt.settings()[0]._bInitComplete?this._startup(a):this.s.dt.settings()[0].aoInitComplete.push({fn:function(){c._startup(a)}})};n.prototype._findPane=function(a){for(var b=0,e=this.s.panes;b<e.length;b++){var c=e[b];if(a===c.s.name)return c}};n.prototype._serverTotals=
function(){for(var a=!1,b=!1,e=this.s.dt,c=0,g=this.s.panes;c<g.length;c++){var d=g[c];if(d.s.selectPresent){this.s.selectionList.push({index:d.s.index,rows:d.s.dtPane.rows({selected:!0}).data().toArray(),protect:!1});e.state.save();d.s.selectPresent=!1;a=!0;break}else d.s.deselect&&(b=d.s.dtPane.rows({selected:!0}).data().toArray(),0<b.length&&this.s.selectionList.push({index:d.s.index,rows:b,protect:!0}),b=a=!0)}if(a){e=[];for(c=0;c<this.s.selectionList.length;c++){d=!1;for(g=c+1;g<this.s.selectionList.length;g++)this.s.selectionList[g].index===
this.s.selectionList[c].index&&(d=!0);if(!d){for(var g=!1,a=0,f=this.s.panes;a<f.length;a++)d=f[a],d.s.index===this.s.selectionList[c].index&&0<d.s.dtPane.rows({selected:!0}).data().toArray().length&&(g=!0);g&&e.push(this.s.selectionList[c])}}this.s.selectionList=e}else this.s.selectionList=[];e=-1;if(b&&1===this.s.selectionList.length){b=0;for(c=this.s.panes;b<c.length;b++)d=c[b],d.s.lastSelect=!1,d.s.deselect=!1,void 0!==d.s.dtPane&&0<d.s.dtPane.rows({selected:!0}).data().toArray().length&&(e=d.s.index)}else if(0<
this.s.selectionList.length){b=this.s.selectionList[this.s.selectionList.length-1].index;c=0;for(g=this.s.panes;c<g.length;c++)d=g[c],d.s.lastSelect=d.s.index===b,d.s.deselect=!1}else if(0===this.s.selectionList.length){b=0;for(c=this.s.panes;b<c.length;b++)d=c[b],d.s.lastSelect=!1,d.s.deselect=!1}j(this.dom.panes).empty();b=0;for(c=this.s.panes;b<c.length;b++)d=c[b],d.s.lastSelect?d._setListeners():d.rebuildPane(void 0,this.s.dt.page.info().serverSide?this.s.serverData:void 0,d.s.index===e?!0:null,
!0),j(this.dom.panes).append(d.dom.container),void 0!==d.s.dtPane&&(j(d.s.dtPane.table().node()).parent()[0].scrollTop=d.s.scrollTop,j.fn.dataTable.select.init(d.s.dtPane))};n.prototype._startup=function(a){var b=this;j(this.dom.container).text("");this._attachExtras();j(this.dom.container).append(this.dom.panes);j(this.dom.panes).empty();var e=this.s.dt.state.loaded();if(this.c.viewTotal&&!this.c.cascadePanes&&null!==e&&void 0!==e&&void 0!==e.searchPanes&&void 0!==e.searchPanes.panes){for(var c=
!1,g=0,d=e.searchPanes.panes;g<d.length;g++){var f=d[g];if(0<f.selected.length){c=!0;break}}if(c){c=0;for(g=this.s.panes;c<g.length;c++)f=g[c],f.s.showFiltered=!0}}c=0;for(g=this.s.panes;c<g.length;c++)f=g[c],f.rebuildPane(void 0,0<Object.keys(this.s.serverData).length?this.s.serverData:void 0),j(this.dom.panes).append(f.dom.container);"auto"===this.c.layout&&this.resizePanes();!this.s.stateRead&&(null!==e&&void 0!==e)&&(this.s.dt.page(e.start/this.s.dt.page.len()),this.s.dt.draw("page"));this.s.stateRead=
!0;if(this.c.viewTotal&&!this.c.cascadePanes){e=0;for(c=this.s.panes;e<c.length;e++)f=c[e],f.updatePane()}this._updateFilterCount();this._checkMessage();a.on("preDraw.dtsps",function(){if(!b.s.updating){b._updateFilterCount();(b.c.cascadePanes||b.c.viewTotal)&&!b.s.dt.page.info().serverSide?b.redrawPanes(b.c.viewTotal):b._updateSelection();b.s.filterPane=-1}});j(window).on("resize.dtsp",q.util.throttle(function(){b.resizePanes()}));this.s.dt.on("stateSaveParams.dtsp",function(a,d,c){if(c.searchPanes===
void 0)c.searchPanes={};c.searchPanes.selectionList=b.s.selectionList});if(this.s.dt.page.info().serverSide)a.off("page"),a.on("page",function(){b.s.page=b.s.dt.page()}),a.off("preXhr.dt"),a.on("preXhr.dt",function(a,d,c){if(c.searchPanes===void 0)c.searchPanes={};for(var d=a=0,e=b.s.panes;d<e.length;d++){var f=e[d],g=b.s.dt.column(f.s.index).dataSrc();c.searchPanes[g]===void 0&&(c.searchPanes[g]={});if(f.s.dtPane!==void 0)for(var f=f.s.dtPane.rows({selected:true}).data().toArray(),h=0;h<f.length;h++){c.searchPanes[g][h]=
f[h].filter;a++}}b.c.viewTotal&&b._prepViewTotal(a);if(a>0){if(a!==b.s.filterCount){c.start=0;b.s.page=0}else c.start=b.s.page*b.s.dt.page.len();b.s.dt.page(b.s.page);b.s.filterCount=a}});else a.on("preXhr.dt",function(){for(var a=0,d=b.s.panes;a<d.length;a++)d[a].clearData()});this.s.dt.on("xhr",function(){var a=false;if(!b.s.dt.page.info().serverSide)b.s.dt.one("preDraw",function(){if(!a){var d=b.s.dt.page();a=true;b.s.updating=true;j(b.dom.panes).empty();for(var c=0,e=b.s.panes;c<e.length;c++){var f=
e[c];f.clearData();f.rebuildPane(b.s.selectionList[b.s.selectionList.length-1]!==void 0?f.s.index===b.s.selectionList[b.s.selectionList.length-1].index:false,void 0,void 0,true);j(b.dom.panes).append(f.dom.container)}b.s.dt.page.info().serverSide||b.s.dt.draw();b.s.updating=false;b.c.cascadePanes||b.c.viewTotal?b.redrawPanes(b.c.cascadePanes):b._updateSelection();b._checkMessage();b.s.dt.one("draw",function(){b.s.updating=true;b.s.dt.page(d).draw(false);b.s.updating=false})}})});e=0;for(c=this.s.panes;e<
c.length;e++)if(f=c[e],void 0!==f&&void 0!==f.s.dtPane&&(void 0!==f.s.colOpts.preSelect&&0<f.s.colOpts.preSelect.length||null!==f.customPaneSettings&&void 0!==f.customPaneSettings.preSelect&&0<f.customPaneSettings.preSelect.length)){g=f.s.dtPane.rows().data().toArray().length;for(d=0;d<g;d++)(-1!==f.s.colOpts.preSelect.indexOf(f.s.dtPane.cell(d,0).data())||null!==f.customPaneSettings&&void 0!==f.customPaneSettings.preSelect&&-1!==f.customPaneSettings.preSelect.indexOf(f.s.dtPane.cell(d,0).data()))&&
f.s.dtPane.row(d).select();f.updateTable()}if(void 0!==this.s.selectionList&&0<this.s.selectionList.length){e=this.s.selectionList[this.s.selectionList.length-1].index;c=0;for(g=this.s.panes;c<g.length;c++)f=g[c],f.s.lastSelect=f.s.index===e}0<this.s.selectionList.length&&this.c.cascadePanes&&this._cascadeRegen(this.s.selectionList,this.s.selectionList.length);this._updateFilterCount();a.on("destroy.dtsps",function(){for(var d=0,c=b.s.panes;d<c.length;d++)c[d].destroy();a.off(".dtsps");j(b.dom.clearAll).off(".dtsps");
j(b.dom.container).remove();b.clearSelections()});if(this.c.clear)j(this.dom.clearAll).on("click.dtsps",function(){b.clearSelections()});a.settings()[0]._searchPanes=this};n.prototype._prepViewTotal=function(a){for(var b=this.s.filterPane,e=!1,c=0,g=this.s.panes;c<g.length;c++){var d=g[c];if(void 0!==d.s.dtPane){var f=d.s.dtPane.rows({selected:!0}).data().toArray().length;0<f&&-1===b?(b=d.s.index,e=!0):0<f&&(b=null)}}null!==a&&0!==a&&(b=null);a=0;for(c=this.s.panes;a<c.length;a++)if(d=c[a],void 0!==
d.s.dtPane&&(d.s.filteringActive=!0,-1!==b&&null!==b&&b===d.s.index||!1===e))d.s.filteringActive=!1};n.prototype._updateFilterCount=function(){for(var a=0,b=0,e=this.s.panes;b<e.length;b++){var c=e[b];void 0!==c.s.dtPane&&(a+=c.getPaneCount())}b=this.s.dt.i18n("searchPanes.title",this.c.i18n.title,a);j(this.dom.title).text(b);void 0!==this.c.filterChanged&&"function"===typeof this.c.filterChanged&&this.c.filterChanged.call(this.s.dt,a);0===a?j(this.dom.clearAll).addClass(this.classes.disabledButton).attr("disabled",
"true"):j(this.dom.clearAll).removeClass(this.classes.disabledButton).removeAttr("disabled")};n.prototype._updateSelection=function(){this.s.selectionList=[];for(var a=0,b=this.s.panes;a<b.length;a++){var e=b[a];void 0!==e.s.dtPane&&this.s.selectionList.push({index:e.s.index,rows:e.s.dtPane.rows({selected:!0}).data().toArray(),protect:!1})}this.s.dt.state.save()};n.version="1.3.0";n.classes={clear:"dtsp-clear",clearAll:"dtsp-clearAll",container:"dtsp-searchPanes",disabledButton:"dtsp-disabledButton",
emptyMessage:"dtsp-emptyMessage",hide:"dtsp-hidden",panes:"dtsp-panesContainer",search:"dtsp-search",title:"dtsp-title",titleRow:"dtsp-titleRow"};n.defaults={cascadePanes:!1,clear:!0,container:function(a){return a.table().container()},columns:[],filterChanged:void 0,i18n:{clearMessage:"Clear All",clearPane:"&times;",collapse:{"0":"SearchPanes",_:"SearchPanes (%d)"},count:"{total}",countFiltered:"{shown} ({total})",emptyMessage:"<em>No data</em>",emptyPanes:"No SearchPanes",loadMessage:"Loading Search Panes...",
title:"Filters Active - %d"},layout:"auto",order:[],panes:[],viewTotal:!1};u=n;var v=function(a,b,e){function c(a,b,c){void 0===b&&(b=null);void 0===c&&(c=!1);a=new g.Api(a);b=b?b:a.init().searchPanes||g.defaults.searchPanes;return(new u(a,b,c)).getNode()}h=a;s=a.fn.dataTable;j=a;var g=q=a.fn.dataTable;a.fn.dataTable.SearchPanes=u;a.fn.DataTable.SearchPanes=u;a.fn.dataTable.SearchPane=t;a.fn.DataTable.SearchPane=t;b=a.fn.dataTable.Api.register;b("searchPanes()",function(){return this});b("searchPanes.clearSelections()",
...
{text:"Clear Panes",action:function(a,b){b.searchPanes.clearSelections()}};a.fn.dataTable.ext.buttons.searchPanes={action:function(a,b,c,e){a.stopPropagation();this.popover(e._panes.getNode(),{align:"dt-container"});e._panes.rebuild(void 0,!0)},config:{},init:function(b,c,e){var g=new a.fn.dataTable.SearchPanes(b,a.extend({filterChanged:function(a){b.button(c).text(b.i18n("searchPanes.collapse",g.c.i18n.collapse,a))}},e.config)),h=b.i18n("searchPanes.collapse",g.c.i18n.collapse,0);b.button(c).text(h);
e._panes=g},text:"Search Panes"};a(e).on("preInit.dt.dtsp",function(a,b){if("dt"===a.namespace&&(b.oInit.searchPanes||g.defaults.searchPanes))b._searchPanes||c(b,null,!0)});g.ext.feature.push({cFeature:"P",fnInit:c});g.ext.features&&g.ext.features.register("searchPanes",c)};"function"===typeof define&&define.amd?define(["jquery","datatables.net"],function(a){return v(a,window,document)}):"object"===typeof exports?module.exports=function(a,b){a||(a=window);if(!b||!b.fn.dataTable)b=require("datatables.net")(a,
