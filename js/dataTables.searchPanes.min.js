...
function(){e=setTimeout(function(){a.s.dt.page.info().serverSide&&!a.s.updating?a.s.serverSelecting||(a.s.serverSelect=a.s.dtPane.rows({selected:!0}).data().toArray(),a.s.deselect=!0,a.s.dt.draw(!1)):(a.s.deselect=!0,0===a.s.dtPane.rows({selected:!0}).data().toArray().length&&h(a.dom.clear).addClass(a.classes.disabledButton),a._makeSelection(),a.s.deselect=!1,a.s.dt.state.save())},50)});this.s.dt.on("stateSaveParams.dtsp",function(c,e,d){if(h.isEmptyObject(d))a.s.dtPane.state.clear();else{var c=[],
f,i,p,k;void 0!==a.s.dtPane&&(c=a.s.dtPane.rows({selected:!0}).data().map(function(a){return a.filter.toString()}).toArray(),f=h(a.dom.searchBox).val(),i=a.s.dtPane.order(),p=b.binsOriginal,k=b.arrayOriginal);void 0===d.searchPanes&&(d.searchPanes={});void 0===d.searchPanes.panes&&(d.searchPanes.panes=[]);for(e=0;e<d.searchPanes.panes.length;e++)d.searchPanes.panes[e].id===a.s.index&&(d.searchPanes.panes.splice(e,1),e--);d.searchPanes.panes.push({arrayFilter:k,bins:p,id:a.s.index,order:i,searchTerm:f,
selected:c})}});this.s.dtPane.on("user-select.dtsp",function(a,b,d,f,e){e.stopPropagation()});this.s.dtPane.on("draw.dtsp",function(){a.adjustTopRow()});h(this.dom.nameButton).on("click.dtsp",function(){var b=a.s.dtPane.order()[0][1];a.s.dtPane.order([0,"asc"===b?"desc":"asc"]).draw();a.s.dt.state.save()});h(this.dom.countButton).on("click.dtsp",function(){var b=a.s.dtPane.order()[0][1];a.s.dtPane.order([1,"asc"===b?"desc":"asc"]).draw();a.s.dt.state.save()});h(this.dom.clear).on("click.dtsp",function(){a.dom.container.find("."+
...
this.s.dt.state.save();return!0};l.prototype._addOption=function(a,b,e,c,g,d){if(Array.isArray(a)||a instanceof s.Api)if(a instanceof s.Api&&(a=a.toArray(),b=b.toArray()),a.length===b.length)for(var f=0;f<a.length;f++)d[a[f]]?d[a[f]]++:(d[a[f]]=1,g.push({display:b[f],filter:a[f],sort:e[f],type:c[f]})),this.s.rowData.totalOptions++;else throw Error("display and filter not the same length");else"string"===typeof this.s.colOpts.orthogonal?(d[a]?d[a]++:(d[a]=1,g.push({display:b,filter:a,sort:e,type:c})),
this.s.rowData.totalOptions++):g.push({display:b,filter:a,sort:e,type:c})};l.prototype._buildPane=function(a,b,e,c,g){var d=this;void 0===a&&(a=[]);void 0===b&&(b=!1);void 0===e&&(e=null);void 0===c&&(c=null);void 0===g&&(g=null);this.selections=[];var f=this.s.dt,i=f.column(this.colExists?this.s.index:0),p=this.s.colOpts,k=this.s.rowData,j=f.i18n("searchPanes.count",this.c.i18n.count),l=f.i18n("searchPanes.countFiltered",this.c.i18n.countFiltered),r=f.state.loaded();this.s.listSet&&(r=f.state());
if(this.colExists){var o=-1;if(r&&r.searchPanes&&r.searchPanes.panes)for(var m=0;m<r.searchPanes.panes.length;m++)if(r.searchPanes.panes[m].id===this.s.index){o=m;break}if((!1===p.show||void 0!==p.show&&!0!==p.show)&&-1===o)return this.dom.container.addClass(this.classes.hidden),this.s.displayed=!1;if(!0===p.show||-1!==o)this.s.displayed=!0;if(!this.s.dt.page.info().serverSide&&(null===e||null===e.searchPanes||null===e.searchPanes.options)){if(0===k.arrayFilter.length){this._populatePane(b);this.s.rowData.totalOptions=
...
k.arrayTotals.length?(this.s.rowData.totalOptions=0,this._detailsPane()):k.binsTotal=k.bins;this.dom.container.addClass(this.classes.show);this.s.displayed=!0}else if(null!==e&&null!==e.searchPanes&&null!==e.searchPanes.options){if(void 0!==e.tableLength)this.s.tableLength=e.tableLength,this.s.rowData.totalOptions=this.s.tableLength;else if(null===this.s.tableLength||f.rows()[0].length>this.s.tableLength)this.s.tableLength=f.rows()[0].length,this.s.rowData.totalOptions=this.s.tableLength;b=f.column(this.s.index).dataSrc();
...
emptyMessage:"<em>No data</em>",emptyPanes:"No SearchPanes",loadMessage:"Loading Search Panes...",title:"Filters Active - %d"},layout:"auto",order:[],panes:[],viewTotal:!1};u=n;var v=function(a,b,e){function c(a,b,c){void 0===b&&(b=null);void 0===c&&(c=!1);a=new g.Api(a);b=b?b:a.init().searchPanes||g.defaults.searchPanes;return(new u(a,b,c)).getNode()}h=a;s=a.fn.dataTable;j=a;var g=q=a.fn.dataTable;a.fn.dataTable.SearchPanes=u;a.fn.DataTable.SearchPanes=u;a.fn.dataTable.SearchPane=t;a.fn.DataTable.SearchPane=
