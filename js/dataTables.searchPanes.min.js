...
0;b<a.length;b++)for(var e=function(d){if(d.s.index===a[b].index&&void 0!==d.s.dtPane){b===a.length-1&&(d.s.lastCascade=!0);0<d.s.dtPane.rows({selected:!0}).data().toArray().length&&void 0!==d.s.dtPane&&(d.setClear(!0),d.clearPane(),d.setClear(!1));for(var e=function(a){var b=false;d.s.dtPane.rows().every(function(c){if(d.s.dtPane.row(c).data()!==void 0&&a!==void 0&&d.s.dtPane.row(c).data().filter===a.filter){b=true;d.s.dtPane.row(c).select()}});b||d.addRow(a.display,a.filter,0,a.total,a.sort,a.type,
