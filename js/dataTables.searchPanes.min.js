...
".")).each(function(){j(this).val("");j(this).trigger("input")});for(var a=[],b=0,c=this.s.panes;b<c.length;b++){var e=c[b];void 0!==e.s.dtPane&&a.push(e.clearPane())}return a};n.prototype.getNode=function(){return this.dom.container};n.prototype.rebuild=function(a,b){void 0===a&&(a=!1);void 0===b&&(b=!1);j(this.dom.emptyMessage).remove();var c=[];!1===a&&j(this.dom.panes).empty();for(var e=0,f=this.s.panes;e<f.length;e++){var d=f[e];!1!==a&&d.s.index!==a||(d.clearData(),c.push(d.rebuildPane(void 0!==
...
this._attachExtras();j(this.dom.container).append(this.dom.panes);j(this.dom.panes).empty();var c=this.s.dt.state.loaded();if(this.c.viewTotal&&!this.c.cascadePanes&&null!==c&&void 0!==c&&void 0!==c.searchPanes&&void 0!==c.searchPanes.panes){for(var e=!1,f=0,d=c.searchPanes.panes;f<d.length;f++){var g=d[f];if(0<g.selected.length){e=!0;break}}if(e){e=0;for(f=this.s.panes;e<f.length;e++)g=f[e],g.s.showFiltered=!0}}e=0;for(f=this.s.panes;e<f.length;e++)g=f[e],g.rebuildPane(void 0,0<Object.keys(this.s.serverData).length?
...
b.redrawPanes(b.c.viewTotal):b._updateSelection();b.s.filterPane=-1});j(window).on("resize.dtsp",q.util.throttle(function(){b.resizePanes()}));this.s.dt.on("stateSaveParams.dtsp",function(a,d,c){if(c.searchPanes===void 0)c.searchPanes={};c.searchPanes.selectionList=b.s.selectionList});if(this.s.dt.page.info().serverSide)a.off("page"),a.on("page",function(){b.s.page=b.s.dt.page()}),a.off("preXhr.dt"),a.on("preXhr.dt",function(a,d,c){if(c.searchPanes===void 0)c.searchPanes={};for(var d=a=0,e=b.s.panes;d<
e.length;d++){var f=e[d],g=b.s.dt.column(f.s.index).dataSrc();c.searchPanes[g]===void 0&&(c.searchPanes[g]={});if(f.s.dtPane!==void 0)for(var f=f.s.dtPane.rows({selected:true}).data().toArray(),h=0;h<f.length;h++){c.searchPanes[g][h]=f[h].filter;a++}}b.c.viewTotal&&b._prepViewTotal(a);if(a>0){if(a!==b.s.filterCount){c.start=0;b.s.page=0}else c.start=b.s.page*b.s.dt.page.len();b.s.dt.page(b.s.page);b.s.filterCount=a}});else a.on("preXhr.dt",function(){for(var a=0,d=b.s.panes;a<d.length;a++)d[a].clearData()});
this.s.dt.on("xhr",function(){var a=false;if(!b.s.dt.page.info().serverSide)b.s.dt.one("preDraw",function(){if(!a){var d=b.s.dt.page();a=true;j(b.dom.panes).empty();for(var c=0,e=b.s.panes;c<e.length;c++){var f=e[c];f.clearData();f.rebuildPane(b.s.selectionList[b.s.selectionList.length-1]!==void 0?f.s.index===b.s.selectionList[b.s.selectionList.length-1].index:false,void 0,void 0,true);j(b.dom.panes).append(f.dom.container)}b.s.dt.page.info().serverSide||b.s.dt.draw();b.c.cascadePanes||b.c.viewTotal?
b.redrawPanes(b.c.cascadePanes):b._updateSelection();b._checkMessage();b.s.dt.one("draw",function(){b.s.dt.page(d).draw(false)})}})});c=0;for(e=this.s.panes;c<e.length;c++)if(g=e[c],void 0!==g&&void 0!==g.s.dtPane&&(void 0!==g.s.colOpts.preSelect&&0<g.s.colOpts.preSelect.length||null!==g.customPaneSettings&&void 0!==g.customPaneSettings.preSelect&&0<g.customPaneSettings.preSelect.length)){f=g.s.dtPane.rows().data().toArray().length;for(d=0;d<f;d++)(-1!==g.s.colOpts.preSelect.indexOf(g.s.dtPane.cell(d,
0).data())||null!==g.customPaneSettings&&void 0!==g.customPaneSettings.preSelect&&-1!==g.customPaneSettings.preSelect.indexOf(g.s.dtPane.cell(d,0).data()))&&g.s.dtPane.row(d).select();g.updateTable()}if(void 0!==this.s.selectionList&&0<this.s.selectionList.length){c=this.s.selectionList[this.s.selectionList.length-1].index;e=0;for(f=this.s.panes;e<f.length;e++)g=f[e],g.s.lastSelect=g.s.index===c}0<this.s.selectionList.length&&this.c.cascadePanes&&this._cascadeRegen(this.s.selectionList,this.s.selectionList.length);
this._updateFilterCount();a.on("destroy.dtsps",function(){for(var d=0,c=b.s.panes;d<c.length;d++)c[d].destroy();a.off(".dtsps");j(b.dom.clearAll).off(".dtsps");j(b.dom.container).remove();b.clearSelections()});if(this.c.clear)j(this.dom.clearAll).on("click.dtsps",function(){b.clearSelections()});a.settings()[0]._searchPanes=this};n.prototype._prepViewTotal=function(a){for(var b=this.s.filterPane,c=!1,e=0,f=this.s.panes;e<f.length;e++){var d=f[e];if(void 0!==d.s.dtPane){var g=d.s.dtPane.rows({selected:!0}).data().toArray().length;
0<g&&-1===b?(b=d.s.index,c=!0):0<g&&(b=null)}}null!==a&&0!==a&&(b=null);a=0;for(e=this.s.panes;a<e.length;a++)if(d=e[a],void 0!==d.s.dtPane&&(d.s.filteringActive=!0,-1!==b&&null!==b&&b===d.s.index||!1===c))d.s.filteringActive=!1};n.prototype._updateFilterCount=function(){for(var a=0,b=0,c=this.s.panes;b<c.length;b++){var e=c[b];void 0!==e.s.dtPane&&(a+=e.getPaneCount())}b=this.s.dt.i18n("searchPanes.title",this.c.i18n.title,a);j(this.dom.title).text(b);void 0!==this.c.filterChanged&&"function"===
