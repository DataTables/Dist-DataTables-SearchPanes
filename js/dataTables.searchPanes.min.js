...
d){for(var e in d)d.hasOwnProperty(e)&&(c[e]=d[e])};return h(a,b)};return function(a,b){function c(){this.constructor=a}h(a,b);a.prototype=null===b?Object.create(b):(c.prototype=b.prototype,new c)}}(),t,p=function(h){function a(b,c,d,e,f){return h.call(this,b,t.extend({i18n:{countFiltered:"{shown} ({total})"}},c),d,e,f)||this}I(a,h);a.prototype._getMessage=function(b){var c=this.s.dt.i18n("searchPanes.count",this.c.i18n.count),d=this.s.dt.i18n("searchPanes.countFiltered",this.c.i18n.countFiltered);
...
new L(e,f,g):new J(e,f,g)).getNode()}l(h);n(h);N=x=t=h;var d=h.fn.dataTable;h.fn.dataTable.SearchPanes=J;h.fn.DataTable.SearchPanes=J;h.fn.dataTable.SearchPanesST=L;h.fn.DataTable.SearchPanesST=L;h.fn.dataTable.SearchPane=v;h.fn.DataTable.SearchPane=v;h.fn.dataTable.SearchPaneViewTotal=p;h.fn.DataTable.SearchPaneViewTotal=p;h.fn.dataTable.SearchPaneCascade=F;h.fn.DataTable.SearchPaneCascade=F;h.fn.dataTable.SearchPaneCascadeViewTotal=K;h.fn.DataTable.SearchPaneCascadeViewTotal=K;a=h.fn.dataTable.Api.register;
...
e._searchPanes.getNode():null});h.fn.dataTable.ext.buttons.searchPanesClear={action:function(e,f){f.searchPanes.clearSelections()},text:"Clear Panes"};h.fn.dataTable.ext.buttons.searchPanes={action:function(e,f,g,m){this.popover(m._panes.getNode(),{align:"container",span:"container"});m._panes.rebuild(void 0,!0)},config:{},init:function(e,f,g){var m=h.extend({filterChanged:function(q){e.button(f).text(e.i18n("searchPanes.collapse",void 0!==e.context[0].oLanguage.searchPanes?e.context[0].oLanguage.searchPanes.collapse:
e.context[0]._searchPanes.c.i18n.collapse,q))}},g.config);m=m&&(m.cascadePanes||m.viewTotal)?new h.fn.dataTable.SearchPanesST(e,m):new h.fn.dataTable.SearchPanes(e,m);e.button(f).text(g.text||e.i18n("searchPanes.collapse",m.c.i18n.collapse,0));g._panes=m},text:null};h(b).on("preInit.dt.dtsp",function(e,f){"dt"===e.namespace&&(f.oInit.searchPanes||d.defaults.searchPanes)&&(f._searchPanes||c(f,null,!0))});d.ext.feature.push({cFeature:"P",fnInit:c});d.ext.features&&d.ext.features.register("searchPanes",
c)})})();
