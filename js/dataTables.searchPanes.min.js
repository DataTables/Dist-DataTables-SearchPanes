...
filter:b,index:i,shown:e,sort:g,total:c,type:d})};l.prototype.adjustTopRow=function(){var a=this.dom.container.find("."+this.classes.subRowsContainer.replace(/\s+/g,".")),b=this.dom.container.find("."+this.classes.subRow1.replace(/\s+/g,".")),e=this.dom.container.find("."+this.classes.subRow2.replace(/\s+/g,".")),c=this.dom.container.find("."+this.classes.topRow.replace(/\s+/g,"."));(252>h(a[0]).width()||252>h(c[0]).width())&&0!==h(a[0]).width()?(h(a[0]).addClass(this.classes.narrow),h(b[0]).addClass(this.classes.narrowSub).removeClass(this.classes.narrowSearch),
...
filter:a,sort:e,type:c})),this.s.rowData.totalOptions++):g.push({display:b,filter:a,sort:e,type:c})};l.prototype._buildPane=function(a,b,e,c,g){var d=this;void 0===a&&(a=[]);void 0===b&&(b=!1);void 0===e&&(e=null);void 0===c&&(c=null);void 0===g&&(g=null);this.selections=[];var f=this.s.dt,i=f.column(this.colExists?this.s.index:0),p=this.s.colOpts,k=this.s.rowData,j=f.i18n("searchPanes.count",this.c.i18n.count),l=f.i18n("searchPanes.countFiltered",this.c.i18n.countFiltered),q=f.state.loaded();this.s.listSet&&
(q=f.state());if(this.colExists){var o=-1;if(q&&q.searchPanes&&q.searchPanes.panes)for(var m=0;m<q.searchPanes.panes.length;m++)if(q.searchPanes.panes[m].id===this.s.index){o=m;break}if((!1===p.show||void 0!==p.show&&!0!==p.show)&&-1===o)return this.dom.container.addClass(this.classes.hidden),this.s.displayed=!1;if(!0===p.show||-1!==o)this.s.displayed=!0;if(!this.s.dt.page.info().serverSide&&(null===e||null===e.searchPanes||null===e.searchPanes.options)){if(0===k.arrayFilter.length){this._populatePane(b);
...
m=h.fn.dataTable.ext.errMode;h.fn.dataTable.ext.errMode="none";g=s.Scroller;this.s.dtPane=h(this.dom.dtP).DataTable(h.extend(!0,{columnDefs:[{className:"dtsp-nameColumn",data:"display",render:function(a,b,c){if(b==="sort")return c.sort;if(b==="type")return c.type;var f;f=(d.s.filteringActive||d.s.showFiltered)&&d.c.viewTotal||d.c.viewTotal&&d.s.forceViewTotal?l.replace(/{total}/,c.total):j.replace(/{total}/,c.total);for(f=f.replace(/{shown}/,c.shown);f.indexOf("{total}")!==-1;)f=f.replace(/{total}/,
...
b){h(a).addClass(b.className)}}:void 0,null!==this.customPaneSettings&&void 0!==this.customPaneSettings.dtOpts?this.customPaneSettings.dtOpts:{},h.fn.dataTable.versionCheck("2")?{layout:{bottomLeft:null,bottomRight:null,topLeft:null,topRight:null}}:{}));h(this.dom.dtP).addClass(this.classes.table);g="Custom Pane";this.customPaneSettings&&this.customPaneSettings.header?g=this.customPaneSettings.header:p.header?g=p.header:this.colExists&&(g=h.fn.dataTable.versionCheck("2")?f.column(this.s.index).title():
f.settings()[0].aoColumns[this.s.index].sTitle);this.dom.searchBox.attr("placeholder",g);h.fn.dataTable.select.init(this.s.dtPane);h.fn.dataTable.ext.errMode=m;if(this.colExists){var i=(i=i.search())?i.substr(1,i.length-2).split("|"):[],n=0;k.arrayFilter.forEach(function(a){""===a.filter&&n++});m=0;for(g=k.arrayFilter.length;m<g;m++){for(var i=!1,o=0,r=this.s.serverSelect;o<r.length;o++)b=r[o],b.filter===k.arrayFilter[m].filter&&(i=!0);if(this.s.dt.page.info().serverSide&&(!this.c.cascadePanes||this.c.cascadePanes&&
0!==k.bins[k.arrayFilter[m].filter]||this.c.cascadePanes&&null!==c||i)){i=this.addRow(k.arrayFilter[m].display,k.arrayFilter[m].filter,c?k.binsTotal[k.arrayFilter[m].filter]:k.bins[k.arrayFilter[m].filter],this.c.viewTotal||c?String(k.binsTotal[k.arrayFilter[m].filter]):k.bins[k.arrayFilter[m].filter],k.arrayFilter[m].sort,k.arrayFilter[m].type);o=0;for(r=this.s.serverSelect;o<r.length;o++)b=r[o],b.filter===k.arrayFilter[m].filter&&(this.s.serverSelecting=!0,i.select(),this.s.serverSelecting=!1)}else!this.s.dt.page.info().serverSide&&
...
q.searchPanes&&q.searchPanes.panes&&(null===e||1===e.draw)){this.c.cascadePanes||this._reloadSelect(q);e=0;for(q=q.searchPanes.panes;e<q.length;e++)a=q[e],a.id===this.s.index&&(h(this.dom.searchBox).val(a.searchTerm),h(this.dom.searchBox).trigger("input"),this.s.dtPane.order(a.order).draw())}this.s.dt.state.save();return!0};l.prototype._detailsPane=function(){var a=this.s.dt;this.s.rowData.arrayTotals=[];this.s.rowData.binsTotal={};var b=this.s.dt.settings()[0],a=a.rows().indexes();if(!this.s.dt.page.info().serverSide)for(var e=
...
{},l.defaults,{orthogonal:{threshold:null},threshold:null},void 0!==this.c?this.c:{})};l.prototype._getComparisonRows=function(){var a=this.s.colOpts,a=void 0!==a.options?a.options:null!==this.customPaneSettings&&void 0!==this.customPaneSettings.options?this.customPaneSettings.options:void 0;if(void 0!==a){var b=this.s.dt.rows({search:"applied"}).data().toArray(),e=this.s.dt.rows({search:"applied"}),c=this.s.dt.rows().data().toArray(),g=this.s.dt.rows(),d=[];this.s.dtPane.clear();for(var f=0;f<a.length;f++){var i=
a[f],h=""!==i.label?i.label:this.emptyMessage(),k=i.className,j=h,l="function"===typeof i.value?i.value:[],q=0,o=h,m=0;if("function"===typeof i.value){for(var n=0;n<b.length;n++)i.value.call(this.s.dt,b[n],e[0][n])&&q++;for(n=0;n<c.length;n++)i.value.call(this.s.dt,c[n],g[0][n])&&m++;"function"!==typeof l&&l.push(i.filter)}(!this.c.cascadePanes||this.c.cascadePanes&&0!==q)&&d.push(this.addRow(j,l,q,m,o,h,k))}return d}};l.prototype._getOptions=function(){var a=this.s.dt.settings()[0].aoColumns[this.s.index].searchPanes,
b=h.extend(!0,{},l.defaults,{emptyMessage:!1,orthogonal:{threshold:null},threshold:null},a);void 0!==a&&(void 0!==a.hideCount&&void 0===a.viewCount)&&(b.viewCount=!a.hideCount);return b};l.prototype._makeSelection=function(){this.updateTable();this.s.updating=!0;this.s.dt.draw();this.s.updating=!1};l.prototype._populatePane=function(a){void 0===a&&(a=!1);var b=this.s.dt;this.s.rowData.arrayFilter=[];this.s.rowData.bins={};var e=this.s.dt.settings()[0];if(!this.s.dt.page.info().serverSide)for(var c=
0,a=((this.c.cascadePanes||this.c.viewTotal)&&!this.s.clearing&&!a?b.rows({search:"applied"}).indexes():b.rows().indexes()).toArray();c<a.length;c++)this._populatePaneArray(a[c],this.s.rowData.arrayFilter,e)};l.prototype._populatePaneArray=function(a,b,e,c){void 0===c&&(c=this.s.rowData.bins);var g=this.s.colOpts;if("string"===typeof g.orthogonal)e=e.oApi._fnGetCellData(e,a,this.s.index,g.orthogonal),this.s.rowData.filterMap.set(a,e),this._addOption(e,e,e,e,b,c);else{var d=e.oApi._fnGetCellData(e,
a,this.s.index,g.orthogonal.search);null===d&&(d="");"string"===typeof d&&(d=d.replace(/<[^>]*>/g,""));this.s.rowData.filterMap.set(a,d);c[d]?c[d]++:(c[d]=1,this._addOption(d,e.oApi._fnGetCellData(e,a,this.s.index,g.orthogonal.display),e.oApi._fnGetCellData(e,a,this.s.index,g.orthogonal.sort),e.oApi._fnGetCellData(e,a,this.s.index,g.orthogonal.type),b,c));this.s.rowData.totalOptions++}};l.prototype._reloadSelect=function(a){if(void 0!==a){for(var b,e=0;e<a.searchPanes.panes.length;e++)if(a.searchPanes.panes[e].id===
this.s.index){b=e;break}if(void 0!==b)for(var e=this.s.dtPane,c=e.rows({order:"index"}).data().map(function(a){return null!==a.filter?a.filter.toString():null}).toArray(),g=0,a=a.searchPanes.panes[b].selected;g<a.length;g++){b=a[g];var d=-1;null!==b&&(d=c.indexOf(b.toString()));-1<d&&(this.s.serverSelecting=!0,e.row(d).select(),this.s.serverSelecting=!1)}}};l.prototype._search=function(a,b){for(var e=this.s.colOpts,c=this.s.dt,g=0,d=this.selections;g<d.length;g++){var f=d[g];"string"===typeof f.filter&&
"string"===typeof a&&(f.filter=f.filter.replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"'));if(Array.isArray(a)){if(-1!==a.indexOf(f.filter))return!0}else if("function"===typeof f.filter)if(f.filter.call(c,c.row(b).data(),b)){if("or"===e.combiner)return!0}else{if("and"===e.combiner)return!1}else if(a===f.filter||!("string"===typeof a&&0===a.length)&&a==f.filter||null===f.filter&&"string"===typeof a&&""===a)return!0}return"and"===e.combiner?!0:!1};l.prototype._searchContSetup=
...
(c.arrayFilter=c.arrayOriginal,c.bins=c.binsOriginal):(this.c.viewTotal||this.c.cascadePanes)&&this._populatePane(!this.s.filteringActive);this.c.viewTotal?this._detailsPane():c.binsTotal=c.bins;this.c.viewTotal&&!this.c.cascadePanes&&(c.arrayFilter=c.arrayTotals);for(var g=function(a){if(a&&(c.bins[a.filter]!==void 0&&c.bins[a.filter]!==0&&d.c.cascadePanes||!d.c.cascadePanes||d.s.clearing)){var b=d.addRow(a.display,a.filter,!d.c.viewTotal?c.bins[a.filter]:c.bins[a.filter]!==void 0?c.bins[a.filter]:
0,d.c.viewTotal?String(c.binsTotal[a.filter]):c.bins[a.filter],a.sort,a.type),f=e.findIndex(function(b){return b.filter===a.filter});if(f!==-1){b.select();e.splice(f,1)}}},d=this,f=0,i=c.arrayFilter;f<i.length;f++)g(i[f])}if(void 0!==b.searchPanes&&void 0!==b.searchPanes.options||void 0!==b.options||null!==this.customPaneSettings&&void 0!==this.customPaneSettings.options){g=function(a){var b=e.findIndex(function(b){if(b.display===a.data().display)return!0});-1!==b&&(a.select(),e.splice(b,1))};f=0;
for(i=this._getComparisonRows();f<i.length;f++)b=i[f],g(b)}for(g=0;g<e.length;g++)b=e[g],b=this.addRow(b.display,b.filter,0,this.c.viewTotal?b.total:0,b.display,b.display),this.s.updating=!0,b.select(),this.s.updating=!1;this.s.dtPane.draw();this.s.dtPane.table().node().parentNode.scrollTop=a}};l.version="1.3.0";l.classes={buttonGroup:"dtsp-buttonGroup",buttonSub:"dtsp-buttonSub",clear:"dtsp-clear",clearAll:"dtsp-clearAll",clearButton:"clearButton",container:"dtsp-searchPane",countButton:"dtsp-countButton",
...
viewCount:!0,viewTotal:!1};t=l;var j,r,u,n=function(a,b,e){var c=this;void 0===e&&(e=!1);this.regenerating=!1;if(!r||!r.versionCheck||!r.versionCheck("1.10.0"))throw Error("SearchPane requires DataTables 1.10 or newer");if(!r.select)throw Error("SearchPane requires Select");var g=new r.Api(a);this.classes=j.extend(!0,{},n.classes);this.c=j.extend(!0,{},n.defaults,b);this.dom={clearAll:j('<button type="button">Clear All</button>').addClass(this.classes.clearAll),container:j("<div/>").addClass(this.classes.panes).text(g.i18n("searchPanes.loadMessage",
this.c.i18n.loadMessage)),emptyMessage:j("<div/>").addClass(this.classes.emptyMessage),options:j("<div/>").addClass(this.classes.container),panes:j("<div/>").addClass(this.classes.container),title:j("<div/>").addClass(this.classes.title),titleRow:j("<div/>").addClass(this.classes.titleRow),wrapper:j("<div/>")};this.s={colOpts:[],dt:g,filterCount:0,filterPane:-1,page:0,panes:[],selectionList:[],serverData:{},stateRead:!1,updating:!1};if(void 0===g.settings()[0]._searchPanes){this._getState();if(this.s.dt.page.info().serverSide)g.on("preXhr.dt",
function(a,b,e){void 0===e.searchPanes&&(e.searchPanes={});a=0;for(b=c.s.selectionList;a<b.length;a++){var g=b[a],h=c.s.dt.column(g.index).dataSrc();void 0===e.searchPanes[h]&&(e.searchPanes[h]={});for(var j=0;j<g.rows.length;j++)e.searchPanes[h][j]=g.rows[j].filter}});g.on("xhr",function(a,b,e){e&&(e.searchPanes&&e.searchPanes.options)&&(c.s.serverData=e,c.s.serverData.tableLength=e.recordsTotal,c._serverTotals())});g.settings()[0]._searchPanes=this;this.dom.clearAll.text(g.i18n("searchPanes.clearMessage",
this.c.i18n.clearMessage));if(this.s.dt.settings()[0]._bInitComplete||e)this._paneDeclare(g,a,b);else g.one("preInit.dt",function(){c._paneDeclare(g,a,b)});return this}};n.prototype.clearSelections=function(){this.dom.container.find("."+this.classes.search.replace(/\s+/g,".")).each(function(){j(this).val("");j(this).trigger("input")});for(var a=[],b=0,e=this.s.panes;b<e.length;b++){var c=e[b];void 0!==c.s.dtPane&&a.push(c.clearPane())}return a};n.prototype.getNode=function(){return this.dom.container};
n.prototype.rebuild=function(a,b){void 0===a&&(a=!1);void 0===b&&(b=!1);j(this.dom.emptyMessage).remove();var e=[];!1===a&&j(this.dom.panes).empty();for(var c=0,g=this.s.panes;c<g.length;c++){var d=g[c];!1!==a&&d.s.index!==a||(d.clearData(),e.push(d.rebuildPane(void 0!==this.s.selectionList[this.s.selectionList.length-1]?d.s.index===this.s.selectionList[this.s.selectionList.length-1].index:!1,this.s.dt.page.info().serverSide?this.s.serverData:void 0,null,b)),j(this.dom.panes).append(d.dom.container))}this.c.cascadePanes||
this.c.viewTotal?this.redrawPanes(!0):this._updateSelection();this._updateFilterCount();this._attachPaneContainer();this.s.dt.draw();this.resizePanes();return 1===e.length?e[0]:e};n.prototype.redrawPanes=function(a){void 0===a&&(a=!1);var b=this.s.dt;if(!this.s.updating&&!this.s.dt.page.info().serverSide){for(var e=!0,c=this.s.filterPane,g=null,d=0,f=this.s.panes;d<f.length;d++){var i=f[d];void 0!==i.s.dtPane&&(g+=i.s.dtPane.rows({selected:!0}).data().toArray().length)}if(0===g&&b.rows({search:"applied"}).data().toArray().length===
b.rows().data().toArray().length)e=!1;else if(this.c.viewTotal){d=0;for(f=this.s.panes;d<f.length;d++)if(i=f[d],void 0!==i.s.dtPane){var h=i.s.dtPane.rows({selected:!0}).data().toArray().length;if(0===h)for(var k=0,j=this.s.selectionList;k<j.length;k++){var l=j[k];l.index===i.s.index&&0!==l.rows.length&&(h=l.rows.length)}0<h&&-1===c?c=i.s.index:0<h&&(c=null)}0===g&&(c=null)}f=void 0;d=[];if(this.regenerating){b=-1;1===d.length&&(null!==g&&0!==g)&&(b=d[0].index);a=0;for(d=this.s.panes;a<d.length;a++)if(i=
d[a],void 0!==i.s.dtPane){f=!0;i.s.filteringActive=!0;if(-1!==c&&null!==c&&c===i.s.index||!1===e||i.s.index===b)f=!1,i.s.filteringActive=!1;i.updatePane(!f?f:e)}this._updateFilterCount()}else{h=0;for(k=this.s.panes;h<k.length;h++)if(i=k[h],i.s.selectPresent){this.s.selectionList.push({index:i.s.index,protect:!1,rows:i.s.dtPane.rows({selected:!0}).data().toArray()});b.state.save();break}else i.s.deselect&&(f=i.s.index,j=i.s.dtPane.rows({selected:!0}).data().toArray(),0<j.length&&this.s.selectionList.push({index:i.s.index,
protect:!0,rows:j}));if(0<this.s.selectionList.length){b=this.s.selectionList[this.s.selectionList.length-1].index;h=0;for(k=this.s.panes;h<k.length;h++)i=k[h],i.s.lastSelect=i.s.index===b}for(i=0;i<this.s.selectionList.length;i++)if(this.s.selectionList[i].index!==f||!0===this.s.selectionList[i].protect){b=!1;for(h=i+1;h<this.s.selectionList.length;h++)this.s.selectionList[h].index===this.s.selectionList[i].index&&(b=!0);b||(d.push(this.s.selectionList[i]),this.s.selectionList[i].protect=!1)}b=-1;
1===d.length&&(null!==g&&0!==g)&&(b=d[0].index);h=0;for(k=this.s.panes;h<k.length;h++)if(i=k[h],void 0!==i.s.dtPane){f=!0;i.s.filteringActive=!0;if(-1!==c&&null!==c&&c===i.s.index||!1===e||i.s.index===b)f=!1,i.s.filteringActive=!1;i.updatePane(!f?!1:e)}this._updateFilterCount();if(0<d.length&&(d.length<this.s.selectionList.length||a)){this._cascadeRegen(d,g);b=d[d.length-1].index;c=0;for(a=this.s.panes;c<a.length;c++)i=a[c],i.s.lastSelect=i.s.index===b}else if(0<d.length){i=0;for(a=this.s.panes;i<
a.length;i++)if(d=a[i],void 0!==d.s.dtPane){f=!0;d.s.filteringActive=!0;if(-1!==c&&null!==c&&c===d.s.index||!1===e||d.s.index===b)f=!1,d.s.filteringActive=!1;d.updatePane(!f?f:e)}}}if(!e||0===g)this.s.selectionList=[]}};n.prototype.resizePanes=function(){if("auto"===this.c.layout){for(var a=j(this.s.dt.searchPanes.container()).width(),b=Math.floor(a/260),a=1,e=0,c=[],g=0,d=this.s.panes;g<d.length;g++){var f=d[g];f.s.displayed&&c.push(f.s.index)}f=c.length;if(b===f)a=b;else for(;1<b;b--)if(g=f%b,0===
g){a=b;e=0;break}else g>e&&(a=b,e=g);c=0!==e?c.slice(c.length-e,c.length):[];b=0;for(g=this.s.panes;b<g.length;b++)f=g[b],f.s.displayed&&(d="columns-"+(-1===c.indexOf(f.s.index)?a:e),f.resize(d))}else{a=0;for(e=this.s.panes;a<e.length;a++)f=e[a],f.adjustTopRow()}return this};n.prototype._attach=function(){var a=this;j(this.dom.container).removeClass(this.classes.hide);j(this.dom.titleRow).removeClass(this.classes.hide);j(this.dom.titleRow).remove();j(this.dom.title).appendTo(this.dom.titleRow);this.c.clear&&
(j(this.dom.clearAll).appendTo(this.dom.titleRow),j(this.dom.clearAll).on("click.dtsps",function(){a.clearSelections()}));j(this.dom.titleRow).appendTo(this.dom.container);for(var b=0,e=this.s.panes;b<e.length;b++)j(e[b].dom.container).appendTo(this.dom.panes);j(this.dom.panes).appendTo(this.dom.container);0===j("div."+this.classes.container).length&&j(this.dom.container).prependTo(this.s.dt);return this.dom.container};n.prototype._attachExtras=function(){j(this.dom.container).removeClass(this.classes.hide);
j(this.dom.titleRow).removeClass(this.classes.hide);j(this.dom.titleRow).remove();j(this.dom.title).appendTo(this.dom.titleRow);this.c.clear&&j(this.dom.clearAll).appendTo(this.dom.titleRow);j(this.dom.titleRow).appendTo(this.dom.container);return this.dom.container};n.prototype._attachMessage=function(){var a;try{a=this.s.dt.i18n("searchPanes.emptyPanes",this.c.i18n.emptyPanes)}catch(b){a=null}if(null===a)j(this.dom.container).addClass(this.classes.hide),j(this.dom.titleRow).removeClass(this.classes.hide);
else return j(this.dom.container).removeClass(this.classes.hide),j(this.dom.titleRow).addClass(this.classes.hide),j(this.dom.emptyMessage).text(a),this.dom.emptyMessage.appendTo(this.dom.container),this.dom.container};n.prototype._attachPaneContainer=function(){for(var a=0,b=this.s.panes;a<b.length;a++)if(!0===b[a].s.displayed)return this._attach();return this._attachMessage()};n.prototype._cascadeRegen=function(a,b){this.regenerating=!0;var e=-1;1===a.length&&(null!==b&&0!==b)&&(e=a[0].index);for(var c=
0,g=this.s.panes;c<g.length;c++){var d=g[c];d.setCascadeRegen(!0);d.setClear(!0);(void 0!==d.s.dtPane&&d.s.index===e||void 0!==d.s.dtPane)&&d.clearPane();d.setClear(!1)}this.s.dt.draw();e=this.s.dt.rows({search:"applied"}).data().toArray().length;c=this.s.dt.rows().data().toArray().length;if(c!==e)for(var g=0,f=this.s.panes;g<f.length;g++)d=f[g],d.s.forceViewTotal=!0;g=0;for(f=this.s.panes;g<f.length;g++)d=f[g],d.updatePane(!0);this._makeCascadeSelections(a);this.s.selectionList=a;g=0;for(f=this.s.panes;g<
f.length;g++)d=f[g],d.setCascadeRegen(!1);this.regenerating=!1;if(c!==e){e=0;for(c=this.s.panes;e<c.length;e++)d=c[e],d.s.forceViewTotal=!1}};n.prototype._checkMessage=function(){for(var a=0,b=this.s.panes;a<b.length;a++)if(!0===b[a].s.displayed){j(this.dom.emptyMessage).remove();j(this.dom.titleRow).removeClass(this.classes.hide);return}return this._attachMessage()};n.prototype._getState=function(){var a=this.s.dt.state.loaded();a&&(a.searchPanes&&void 0!==a.searchPanes.selectionList)&&(this.s.selectionList=
a.searchPanes.selectionList)};n.prototype._makeCascadeSelections=function(a){for(var b=0;b<a.length;b++)for(var e=function(d){if(d.s.index===a[b].index&&void 0!==d.s.dtPane){b===a.length-1&&(d.s.lastCascade=!0);0<d.s.dtPane.rows({selected:!0}).data().toArray().length&&void 0!==d.s.dtPane&&(d.setClear(!0),d.clearPane(),d.setClear(!1));for(var e=function(a){var b=false;d.s.dtPane.rows().every(function(c){if(d.s.dtPane.row(c).data()!==void 0&&a!==void 0&&d.s.dtPane.row(c).data().filter===a.filter){b=
true;d.s.dtPane.row(c).select()}});b||d.addRow(a.display,a.filter,0,a.total,a.sort,a.type,a.className).select()},g=0,h=a[b].rows;g<h.length;g++)e(h[g]);d.s.dtPane.draw();c._updateFilterCount();d.s.lastCascade=!1}},c=this,g=0,d=this.s.panes;g<d.length;g++)e(d[g]);this.s.dt.state.save()};n.prototype._paneDeclare=function(a,b,e){var c=this;a.columns(0<this.c.columns.length?this.c.columns:void 0).eq(0).each(function(a){c.s.panes.push(new t(b,e,a,c.c.layout,c.dom.panes))});for(var g=a.columns().eq(0).toArray().length,
d=this.c.panes.length,f=0;f<d;f++)this.s.panes.push(new t(b,e,g+f,this.c.layout,this.dom.panes,this.c.panes[f]));if(0<this.c.order.length){g=this.c.order.map(function(a){return c._findPane(a)});this.dom.panes.empty();this.s.panes=g;g=0;for(d=this.s.panes;g<d.length;g++)this.dom.panes.append(d[g].dom.container)}this.s.dt.settings()[0]._bInitComplete?this._startup(a):this.s.dt.settings()[0].aoInitComplete.push({fn:function(){c._startup(a)}})};n.prototype._findPane=function(a){for(var b=0,e=this.s.panes;b<
e.length;b++){var c=e[b];if(a===c.s.name)return c}};n.prototype._serverTotals=function(){for(var a=!1,b=!1,e=this.s.dt,c=0,g=this.s.panes;c<g.length;c++){var d=g[c];if(d.s.selectPresent){this.s.selectionList.push({index:d.s.index,protect:!1,rows:d.s.dtPane.rows({selected:!0}).data().toArray()});e.state.save();d.s.selectPresent=!1;a=!0;break}else d.s.deselect&&(b=d.s.dtPane.rows({selected:!0}).data().toArray(),0<b.length&&this.s.selectionList.push({index:d.s.index,protect:!0,rows:b}),b=a=!0)}if(a){e=
[];for(c=0;c<this.s.selectionList.length;c++){d=!1;for(g=c+1;g<this.s.selectionList.length;g++)this.s.selectionList[g].index===this.s.selectionList[c].index&&(d=!0);if(!d){for(var g=!1,a=0,f=this.s.panes;a<f.length;a++)d=f[a],d.s.index===this.s.selectionList[c].index&&0<d.s.dtPane.rows({selected:!0}).data().toArray().length&&(g=!0);g&&e.push(this.s.selectionList[c])}}this.s.selectionList=e}else this.s.selectionList=[];e=-1;if(b&&1===this.s.selectionList.length){b=0;for(c=this.s.panes;b<c.length;b++)d=
c[b],d.s.lastSelect=!1,d.s.deselect=!1,void 0!==d.s.dtPane&&0<d.s.dtPane.rows({selected:!0}).data().toArray().length&&(e=d.s.index)}else if(0<this.s.selectionList.length){b=this.s.selectionList[this.s.selectionList.length-1].index;c=0;for(g=this.s.panes;c<g.length;c++)d=g[c],d.s.lastSelect=d.s.index===b,d.s.deselect=!1}else if(0===this.s.selectionList.length){b=0;for(c=this.s.panes;b<c.length;b++)d=c[b],d.s.lastSelect=!1,d.s.deselect=!1}j(this.dom.panes).empty();b=0;for(c=this.s.panes;b<c.length;b++)d=
c[b],d.s.lastSelect?d._setListeners():d.rebuildPane(void 0,this.s.dt.page.info().serverSide?this.s.serverData:void 0,d.s.index===e?!0:null,!0),j(this.dom.panes).append(d.dom.container),void 0!==d.s.dtPane&&(j(d.s.dtPane.table().node()).parent()[0].scrollTop=d.s.scrollTop,j.fn.dataTable.select.init(d.s.dtPane));this._updateSelection()};n.prototype._startup=function(a){var b=this;j(this.dom.container).text("");this._attachExtras();j(this.dom.container).append(this.dom.panes);j(this.dom.panes).empty();
var e=this.s.dt.state.loaded();if(this.c.viewTotal&&!this.c.cascadePanes&&null!==e&&void 0!==e&&void 0!==e.searchPanes&&void 0!==e.searchPanes.panes){for(var c=!1,g=0,d=e.searchPanes.panes;g<d.length;g++){var f=d[g];if(0<f.selected.length){c=!0;break}}if(c){c=0;for(g=this.s.panes;c<g.length;c++)f=g[c],f.s.showFiltered=!0}}c=0;for(g=this.s.panes;c<g.length;c++)f=g[c],f.rebuildPane(void 0,0<Object.keys(this.s.serverData).length?this.s.serverData:void 0),j(this.dom.panes).append(f.dom.container);"auto"===
...
b.s.filterPane=-1}});j(window).on("resize.dtsp",r.util.throttle(function(){b.resizePanes()}));this.s.dt.on("stateSaveParams.dtsp",function(a,d,c){if(c.searchPanes===void 0)c.searchPanes={};c.searchPanes.selectionList=b.s.selectionList});if(this.s.dt.page.info().serverSide)a.off("page"),a.on("page",function(){b.s.page=b.s.dt.page()}),a.off("preXhr.dt"),a.on("preXhr.dt",function(a,d,c){if(c.searchPanes===void 0)c.searchPanes={};for(var d=a=0,e=b.s.panes;d<e.length;d++){var f=e[d],g=b.s.dt.column(f.s.index).dataSrc();
c.searchPanes[g]===void 0&&(c.searchPanes[g]={});if(f.s.dtPane!==void 0)for(var f=f.s.dtPane.rows({selected:true}).data().toArray(),h=0;h<f.length;h++){c.searchPanes[g][h]=f[h].filter;a++}}b.c.viewTotal&&b._prepViewTotal(a);if(a>0){if(a!==b.s.filterCount){c.start=0;b.s.page=0}else c.start=b.s.page*b.s.dt.page.len();b.s.dt.page(b.s.page);b.s.filterCount=a}});else a.on("preXhr.dt",function(){for(var a=0,d=b.s.panes;a<d.length;a++)d[a].clearData()});this.s.dt.on("xhr",function(a,d){if(d.nTable===b.s.dt.table().node()){var c=
false;if(!b.s.dt.page.info().serverSide)b.s.dt.one("preDraw",function(){if(!c){var a=b.s.dt.page();c=true;b.s.updating=true;j(b.dom.panes).empty();for(var d=0,e=b.s.panes;d<e.length;d++){var f=e[d];f.clearData();f.rebuildPane(b.s.selectionList[b.s.selectionList.length-1]!==void 0?f.s.index===b.s.selectionList[b.s.selectionList.length-1].index:false,void 0,void 0,true);j(b.dom.panes).append(f.dom.container)}b.s.dt.page.info().serverSide||b.s.dt.draw();b.s.updating=false;b.c.cascadePanes||b.c.viewTotal?
b.redrawPanes(b.c.cascadePanes):b._updateSelection();b._checkMessage();b.s.dt.one("draw",function(){b.s.updating=true;b.s.dt.page(a).draw(false);b.s.updating=false})}})}});e=0;for(c=this.s.panes;e<c.length;e++)if(f=c[e],void 0!==f&&void 0!==f.s.dtPane&&(void 0!==f.s.colOpts.preSelect&&0<f.s.colOpts.preSelect.length||null!==f.customPaneSettings&&void 0!==f.customPaneSettings.preSelect&&0<f.customPaneSettings.preSelect.length)){g=f.s.dtPane.rows().data().toArray().length;for(d=0;d<g;d++)(-1!==f.s.colOpts.preSelect.indexOf(f.s.dtPane.cell(d,
0).data())||null!==f.customPaneSettings&&void 0!==f.customPaneSettings.preSelect&&-1!==f.customPaneSettings.preSelect.indexOf(f.s.dtPane.cell(d,0).data()))&&f.s.dtPane.row(d).select();f.updateTable()}if(void 0!==this.s.selectionList&&0<this.s.selectionList.length){e=this.s.selectionList[this.s.selectionList.length-1].index;c=0;for(g=this.s.panes;c<g.length;c++)f=g[c],f.s.lastSelect=f.s.index===e}0<this.s.selectionList.length&&this.c.cascadePanes&&this._cascadeRegen(this.s.selectionList,this.s.selectionList.length);
this._updateFilterCount();a.on("destroy.dtsps",function(){for(var d=0,c=b.s.panes;d<c.length;d++)c[d].destroy();a.off(".dtsps");j(b.dom.clearAll).off(".dtsps");j(b.dom.container).remove();b.clearSelections()});if(this.c.clear)j(this.dom.clearAll).on("click.dtsps",function(){b.clearSelections()});a.settings()[0]._searchPanes=this;this.s.dt.state.save()};n.prototype._prepViewTotal=function(a){for(var b=this.s.filterPane,e=!1,c=0,g=this.s.panes;c<g.length;c++){var d=g[c];if(void 0!==d.s.dtPane){var f=
d.s.dtPane.rows({selected:!0}).data().toArray().length;0<f&&-1===b?(b=d.s.index,e=!0):0<f&&(b=null)}}null!==a&&0!==a&&(b=null);a=0;for(c=this.s.panes;a<c.length;a++)if(d=c[a],void 0!==d.s.dtPane&&(d.s.filteringActive=!0,-1!==b&&null!==b&&b===d.s.index||!1===e))d.s.filteringActive=!1};n.prototype._updateFilterCount=function(){for(var a=0,b=0,e=this.s.panes;b<e.length;b++){var c=e[b];void 0!==c.s.dtPane&&(a+=c.getPaneCount())}b=this.s.dt.i18n("searchPanes.title",this.c.i18n.title,a);j(this.dom.title).text(b);
void 0!==this.c.filterChanged&&"function"===typeof this.c.filterChanged&&this.c.filterChanged.call(this.s.dt,a);0===a?j(this.dom.clearAll).addClass(this.classes.disabledButton).attr("disabled","true"):j(this.dom.clearAll).removeClass(this.classes.disabledButton).removeAttr("disabled")};n.prototype._updateSelection=function(){this.s.selectionList=[];for(var a=0,b=this.s.panes;a<b.length;a++){var e=b[a];void 0!==e.s.dtPane&&this.s.selectionList.push({index:e.s.index,protect:!1,rows:e.s.dtPane.rows({selected:!0}).data().toArray()})}this.s.dt.state.save()};
n.version="1.3.0";n.classes={clear:"dtsp-clear",clearAll:"dtsp-clearAll",container:"dtsp-searchPanes",disabledButton:"dtsp-disabledButton",emptyMessage:"dtsp-emptyMessage",hide:"dtsp-hidden",panes:"dtsp-panesContainer",search:"dtsp-search",title:"dtsp-title",titleRow:"dtsp-titleRow"};n.defaults={cascadePanes:!1,clear:!0,columns:[],container:function(a){return a.table().container()},filterChanged:void 0,i18n:{clearMessage:"Clear All",clearPane:"&times;",collapse:{"0":"SearchPanes",_:"SearchPanes (%d)"},
count:"{total}",countFiltered:"{shown} ({total})",emptyMessage:"<em>No data</em>",emptyPanes:"No SearchPanes",loadMessage:"Loading Search Panes...",title:"Filters Active - %d"},layout:"auto",order:[],panes:[],viewTotal:!1};u=n;var v=function(a,b,e){function c(a,b,c){void 0===b&&(b=null);void 0===c&&(c=!1);a=new g.Api(a);b=b?b:a.init().searchPanes||g.defaults.searchPanes;return(new u(a,b,c)).getNode()}h=a;s=a.fn.dataTable;j=a;var g=r=a.fn.dataTable;a.fn.dataTable.SearchPanes=u;a.fn.DataTable.SearchPanes=
u;a.fn.dataTable.SearchPane=t;a.fn.DataTable.SearchPane=t;b=a.fn.dataTable.Api.register;b("searchPanes()",function(){return this});b("searchPanes.clearSelections()",function(){return this.iterator("table",function(a){a._searchPanes&&a._searchPanes.clearSelections()})});b("searchPanes.rebuildPane()",function(a,b){return this.iterator("table",function(c){c._searchPanes&&c._searchPanes.rebuild(a,b)})});b("searchPanes.resizePanes()",function(){var a=this.context[0];return a._searchPanes?a._searchPanes.resizePanes():
null});b("searchPanes.container()",function(){var a=this.context[0];return a._searchPanes?a._searchPanes.getNode():null});a.fn.dataTable.ext.buttons.searchPanesClear={action:function(a,b){b.searchPanes.clearSelections()},text:"Clear Panes"};a.fn.dataTable.ext.buttons.searchPanes={action:function(a,b,c,e){a.stopPropagation();this.popover(e._panes.getNode(),{align:"dt-container"});e._panes.rebuild(void 0,!0)},config:{},init:function(b,c,e){var g=new a.fn.dataTable.SearchPanes(b,a.extend({filterChanged:function(a){b.button(c).text(b.i18n("searchPanes.collapse",
g.c.i18n.collapse,a))}},e.config)),h=b.i18n("searchPanes.collapse",g.c.i18n.collapse,0);b.button(c).text(h);e._panes=g},text:"Search Panes"};a(e).on("preInit.dt.dtsp",function(a,b){if("dt"===a.namespace&&(b.oInit.searchPanes||g.defaults.searchPanes))b._searchPanes||c(b,null,!0)});g.ext.feature.push({cFeature:"P",fnInit:c});g.ext.features&&g.ext.features.register("searchPanes",c)};"function"===typeof define&&define.amd?define(["jquery","datatables.net"],function(a){return v(a,window,document)}):"object"===
