...
_:"SearchPanes (%d)"},count:"{total}",countFiltered:"{shown} ({total})",emptyMessage:"<em>No data</em>",emptyPanes:"No SearchPanes",loadMessage:"Loading Search Panes...",title:"Filters Active - %d"},layout:"auto",order:[],panes:[],viewTotal:!1};u=n;var v=function(a,b,e){function c(a,b,c){void 0===b&&(b=null);void 0===c&&(c=!1);a=new g.Api(a);b=b?b:a.init().searchPanes||g.defaults.searchPanes;return(new u(a,b,c)).getNode()}h=a;s=a.fn.dataTable;j=a;var g=r=a.fn.dataTable;a.fn.dataTable.SearchPanes=
