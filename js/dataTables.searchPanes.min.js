...
a[f],h=""!==i.label?i.label:this.emptyMessage(),k=i.className,j=h,l="function"===typeof i.value?i.value:[],n=0,o=h,m=0;if("function"===typeof i.value){for(var q=0;q<b.length;q++)i.value.call(this.s.dt,b[q],e[0][q])&&n++;for(q=0;q<c.length;q++)i.value.call(this.s.dt,c[q],g[0][q])&&m++;"function"!==typeof l&&l.push(i.filter)}(!this.c.cascadePanes||this.c.cascadePanes&&0!==n)&&d.push(this.addRow(j,l,n,m,o,h,k))}return d}};l.prototype._getOptions=function(){var a=this.s.dt.settings()[0].aoColumns[this.s.index].searchPanes,
...
title:"dtsp-title",topRow:"dtsp-topRow"};l.defaults={cascadePanes:!1,clear:!0,combiner:"or",controls:!0,container:function(a){return a.table().container()},dtOpts:{},emptyMessage:null,hideCount:!1,i18n:{clearPane:"&times;",count:"{total}",countFiltered:"{shown} ({total})",emptyMessage:"<em>No data</em>"},layout:"auto",name:void 0,orderable:!0,orthogonal:{display:"display",filter:"filter",hideCount:!1,search:"filter",show:void 0,sort:"sort",threshold:0.6,type:"type",viewCount:!0},preSelect:[],threshold:0.6,
...
e.length;b++){var c=e[b];if(a===c.s.name)return c}};n.prototype._serverTotals=function(){for(var a=!1,b=!1,e=this.s.dt,c=0,g=this.s.panes;c<g.length;c++){var d=g[c];if(d.s.selectPresent){this.s.selectionList.push({index:d.s.index,rows:d.s.dtPane.rows({selected:!0}).data().toArray(),protect:!1});e.state.save();d.s.selectPresent=!1;a=!0;break}else d.s.deselect&&(b=d.s.dtPane.rows({selected:!0}).data().toArray(),0<b.length&&this.s.selectionList.push({index:d.s.index,rows:b,protect:!0}),b=a=!0)}if(a){e=
...
c.searchPanes[g]===void 0&&(c.searchPanes[g]={});if(f.s.dtPane!==void 0)for(var f=f.s.dtPane.rows({selected:true}).data().toArray(),h=0;h<f.length;h++){c.searchPanes[g][h]=f[h].filter;a++}}b.c.viewTotal&&b._prepViewTotal(a);if(a>0){if(a!==b.s.filterCount){c.start=0;b.s.page=0}else c.start=b.s.page*b.s.dt.page.len();b.s.dt.page(b.s.page);b.s.filterCount=a}});else a.on("preXhr.dt",function(){for(var a=0,d=b.s.panes;a<d.length;a++)d[a].clearData()});this.s.dt.on("xhr",function(){var a=false;if(!b.s.dt.page.info().serverSide)b.s.dt.one("preDraw",
function(){if(!a){var d=b.s.dt.page();a=true;b.s.updating=true;j(b.dom.panes).empty();for(var c=0,e=b.s.panes;c<e.length;c++){var f=e[c];f.clearData();f.rebuildPane(b.s.selectionList[b.s.selectionList.length-1]!==void 0?f.s.index===b.s.selectionList[b.s.selectionList.length-1].index:false,void 0,void 0,true);j(b.dom.panes).append(f.dom.container)}b.s.dt.page.info().serverSide||b.s.dt.draw();b.s.updating=false;b.c.cascadePanes||b.c.viewTotal?b.redrawPanes(b.c.cascadePanes):b._updateSelection();b._checkMessage();
b.s.dt.one("draw",function(){b.s.updating=true;b.s.dt.page(d).draw(false);b.s.updating=false})}})});e=0;for(c=this.s.panes;e<c.length;e++)if(f=c[e],void 0!==f&&void 0!==f.s.dtPane&&(void 0!==f.s.colOpts.preSelect&&0<f.s.colOpts.preSelect.length||null!==f.customPaneSettings&&void 0!==f.customPaneSettings.preSelect&&0<f.customPaneSettings.preSelect.length)){g=f.s.dtPane.rows().data().toArray().length;for(d=0;d<g;d++)(-1!==f.s.colOpts.preSelect.indexOf(f.s.dtPane.cell(d,0).data())||null!==f.customPaneSettings&&
void 0!==f.customPaneSettings.preSelect&&-1!==f.customPaneSettings.preSelect.indexOf(f.s.dtPane.cell(d,0).data()))&&f.s.dtPane.row(d).select();f.updateTable()}if(void 0!==this.s.selectionList&&0<this.s.selectionList.length){e=this.s.selectionList[this.s.selectionList.length-1].index;c=0;for(g=this.s.panes;c<g.length;c++)f=g[c],f.s.lastSelect=f.s.index===e}0<this.s.selectionList.length&&this.c.cascadePanes&&this._cascadeRegen(this.s.selectionList,this.s.selectionList.length);this._updateFilterCount();
a.on("destroy.dtsps",function(){for(var d=0,c=b.s.panes;d<c.length;d++)c[d].destroy();a.off(".dtsps");j(b.dom.clearAll).off(".dtsps");j(b.dom.container).remove();b.clearSelections()});if(this.c.clear)j(this.dom.clearAll).on("click.dtsps",function(){b.clearSelections()});a.settings()[0]._searchPanes=this;this.s.dt.state.save()};n.prototype._prepViewTotal=function(a){for(var b=this.s.filterPane,e=!1,c=0,g=this.s.panes;c<g.length;c++){var d=g[c];if(void 0!==d.s.dtPane){var f=d.s.dtPane.rows({selected:!0}).data().toArray().length;
0<f&&-1===b?(b=d.s.index,e=!0):0<f&&(b=null)}}null!==a&&0!==a&&(b=null);a=0;for(c=this.s.panes;a<c.length;a++)if(d=c[a],void 0!==d.s.dtPane&&(d.s.filteringActive=!0,-1!==b&&null!==b&&b===d.s.index||!1===e))d.s.filteringActive=!1};n.prototype._updateFilterCount=function(){for(var a=0,b=0,e=this.s.panes;b<e.length;b++){var c=e[b];void 0!==c.s.dtPane&&(a+=c.getPaneCount())}b=this.s.dt.i18n("searchPanes.title",this.c.i18n.title,a);j(this.dom.title).text(b);void 0!==this.c.filterChanged&&"function"===
