...
a=void 0!==a.options?a.options:null!==this.customPaneSettings&&void 0!==this.customPaneSettings.options?this.customPaneSettings.options:void 0;if(void 0!==a){var b=this.s.dt.rows({search:"applied"}).data().toArray(),d=this.s.dt.rows({search:"applied"}),c=this.s.dt.rows().data().toArray(),f=this.s.dt.rows(),h=[];this.s.dtPane.clear();for(var e=0;e<a.length;e++){var l=a[e],g=""!==l.label?l.label:this.c.emptyMessage,j=l.className,i=g,k="function"===typeof l.value?l.value:[],n=0,o=g,m=0;if("function"===
typeof l.value){for(var q=0;q<b.length;q++)l.value.call(this.s.dt,b[q],d[0][q])&&n++;for(q=0;q<c.length;q++)l.value.call(this.s.dt,c[q],f[0][q])&&m++;"function"!==typeof k&&k.push(l.filter)}(!this.c.cascadePanes||this.c.cascadePanes&&0!==n)&&h.push(this._addRow(i,k,n,m,o,g,j))}return h}};n.prototype._getOptions=function(){return g.extend(!0,{},n.defaults,{emptyMessage:!1,orthogonal:{threshold:null},threshold:null},this.s.dt.settings()[0].aoColumns[this.s.index].searchPanes)};n.prototype._makeSelection=
function(){this.updateTable();this.s.updating=!0;this.s.dt.draw();this.s.updating=!1};n.prototype._populatePane=function(a){void 0===a&&(a=!1);var b=this.s.dt;this.s.rowData.arrayFilter=[];this.s.rowData.bins={};var d=this.s.dt.settings()[0];if(!this.s.dt.page.info().serverSide)for(var c=0,a=((this.c.cascadePanes||this.c.viewTotal)&&!this.s.clearing&&!a?b.rows({search:"applied"}).indexes():b.rows().indexes()).toArray();c<a.length;c++)this._populatePaneArray(a[c],this.s.rowData.arrayFilter,d)};n.prototype._populatePaneArray=
function(a,b,d,c){void 0===c&&(c=this.s.rowData.bins);var f=this.s.colOpts;if("string"===typeof f.orthogonal)d=d.oApi._fnGetCellData(d,a,this.s.index,f.orthogonal),this.s.rowData.filterMap.set(a,d),this._addOption(d,d,d,d,b,c);else{var h=d.oApi._fnGetCellData(d,a,this.s.index,f.orthogonal.search);null===h&&(h="");"string"===typeof h&&(h=h.replace(/<[^>]*>/g,""));this.s.rowData.filterMap.set(a,h);c[h]?c[h]++:(c[h]=1,this._addOption(h,d.oApi._fnGetCellData(d,a,this.s.index,f.orthogonal.display),d.oApi._fnGetCellData(d,
a,this.s.index,f.orthogonal.sort),d.oApi._fnGetCellData(d,a,this.s.index,f.orthogonal.type),b,c));this.s.rowData.totalOptions++}};n.prototype._reloadSelect=function(a){if(void 0!==a){for(var b,d=0;d<a.searchPanes.panes.length;d++)if(a.searchPanes.panes[d].id===this.s.index){b=d;break}if(void 0!==b)for(var d=this.s.dtPane,c=d.rows({order:"index"}).data().map(function(a){return null!==a.filter?a.filter.toString():null}).toArray(),f=0,a=a.searchPanes.panes[b].selected;f<a.length;f++){b=a[f];var h=-1;
...
g(this.dom.searchLabelCont).appendTo(this.dom.searchCont)};n.prototype._searchExtras=function(){var a=this.s.updating;this.s.updating=!0;var b=this.s.dtPane.rows({selected:!0}).data().pluck("filter").toArray(),d=b.indexOf(!1!==this.s.colOpts.emptyMessage?this.s.colOpts.emptyMessage:this.c.emptyMessage),c=g(this.s.dtPane.table().container());-1<d&&(b[d]="");0<b.length?c.addClass(this.classes.selected):0===b.length&&c.removeClass(this.classes.selected);this.s.updating=a};n.prototype._uniqueRatio=function(a,
...
search:"dtsp-search",searchCont:"dtsp-searchCont",searchIcon:"dtsp-searchIcon",searchLabelCont:"dtsp-searchButtonCont",selected:"dtsp-selected",smallGap:"dtsp-smallGap",subRow1:"dtsp-subRow1",subRow2:"dtsp-subRow2",subRowsContainer:"dtsp-subRowsContainer",title:"dtsp-title",topRow:"dtsp-topRow"};n.defaults={cascadePanes:!1,clear:!0,combiner:"or",controls:!0,container:function(a){return a.table().container()},dtOpts:{},emptyMessage:"<i>No Data</i>",hideCount:!1,layout:"columns-3",name:void 0,orderable:!0,
...
this.s={colOpts:[],dt:f,filterCount:0,filterPane:-1,page:0,panes:[],selectionList:[],serverData:{},stateRead:!1,updating:!1};if(void 0===f.settings()[0]._searchPanes){this._getState();if(this.s.dt.page.info().serverSide)f.on("preXhr.dt",function(a,b,d){void 0===d.searchPanes&&(d.searchPanes={});a=0;for(b=c.s.selectionList;a<b.length;a++){var f=b[a],g=c.s.dt.column(f.index).dataSrc();void 0===d.searchPanes[g]&&(d.searchPanes[g]={});for(var i=0;i<f.rows.length;i++)d.searchPanes[g][i]=f.rows[i].filter}});
f.on("xhr",function(a,b,d){d&&(d.searchPanes&&d.searchPanes.options)&&(c.s.serverData=d,c.s.serverData.tableLength=d.recordsTotal,c._serverTotals())});f.settings()[0]._searchPanes=this;this.dom.clearAll.text(f.i18n("searchPanes.clearMessage","Clear All"));if(this.s.dt.settings()[0]._bInitComplete||d)this._paneDeclare(f,a,b);else f.one("preInit.dt",function(){c._paneDeclare(f,a,b)});return this}};k.prototype.clearSelections=function(){this.dom.container.find(this.classes.search).each(function(){i(this).val("");
...
i(this.dom.titleRow).removeClass(this.classes.hide);i(this.dom.titleRow).remove();i(this.dom.title).appendTo(this.dom.titleRow);this.c.clear&&i(this.dom.clearAll).appendTo(this.dom.titleRow);i(this.dom.titleRow).appendTo(this.dom.container);return this.dom.container};k.prototype._attachMessage=function(){var a;try{a=this.s.dt.i18n("searchPanes.emptyPanes","No SearchPanes")}catch(b){a=null}if(null===a)i(this.dom.container).addClass(this.classes.hide),i(this.dom.titleRow).removeClass(this.classes.hide);
...
(a!==void 0&&e.s.dtPane.row(b).data().filter===a.filter)&&e.s.dtPane.row(b).select()})},f=0,h=a[b].rows;f<h.length;f++)d(h[f]);c._updateFilterCount();e.s.lastCascade=!1}},c=this,f=0,h=this.s.panes;f<h.length;f++)d(h[f]);this.s.dt.state.save()};k.prototype._paneDeclare=function(a,b,d){var c=this;a.columns(0<this.c.columns.length?this.c.columns:void 0).eq(0).each(function(a){c.s.panes.push(new t(b,d,a,c.c.layout,c.dom.panes))});for(var f=a.columns().eq(0).toArray().length,h=this.c.panes.length,e=0;e<
h;e++)this.s.panes.push(new t(b,d,f+e,this.c.layout,this.dom.panes,this.c.panes[e]));if(0<this.c.order.length){f=this.c.order.map(function(a){return c._findPane(a)});this.dom.panes.empty();this.s.panes=f;f=0;for(h=this.s.panes;f<h.length;f++)this.dom.panes.append(h[f].dom.container)}this.s.dt.settings()[0]._bInitComplete?this._startup(a):this.s.dt.settings()[0].aoInitComplete.push({fn:function(){c._startup(a)}})};k.prototype._findPane=function(a){for(var b=0,d=this.s.panes;b<d.length;b++){var c=d[b];
if(a===c.s.name)return c}};k.prototype._serverTotals=function(){for(var a=!1,b=!1,d=this.s.dt,c=0,f=this.s.panes;c<f.length;c++){var h=f[c];if(h.s.selectPresent){this.s.selectionList.push({index:h.s.index,rows:h.s.dtPane.rows({selected:!0}).data().toArray(),protect:!1});d.state.save();h.s.selectPresent=!1;a=!0;break}else h.s.deselect&&(b=h.s.dtPane.rows({selected:!0}).data().toArray(),0<b.length&&this.s.selectionList.push({index:h.s.index,rows:b,protect:!0}),b=a=!0)}if(a){d=[];for(c=0;c<this.s.selectionList.length;c++){h=
!1;for(f=c+1;f<this.s.selectionList.length;f++)this.s.selectionList[f].index===this.s.selectionList[c].index&&(h=!0);if(!h){for(var f=!1,a=0,e=this.s.panes;a<e.length;a++)h=e[a],h.s.index===this.s.selectionList[c].index&&0<h.s.dtPane.rows({selected:!0}).data().toArray().length&&(f=!0);f&&d.push(this.s.selectionList[c])}}this.s.selectionList=d}else this.s.selectionList=[];d=-1;if(b&&1===this.s.selectionList.length){b=0;for(c=this.s.panes;b<c.length;b++)h=c[b],h.s.lastSelect=!1,h.s.deselect=!1,void 0!==
h.s.dtPane&&0<h.s.dtPane.rows({selected:!0}).data().toArray().length&&(d=h.s.index)}else if(0<this.s.selectionList.length){b=this.s.selectionList[this.s.selectionList.length-1].index;c=0;for(f=this.s.panes;c<f.length;c++)h=f[c],h.s.lastSelect=h.s.index===b,h.s.deselect=!1}else if(0===this.s.selectionList.length){b=0;for(c=this.s.panes;b<c.length;b++)h=c[b],h.s.lastSelect=!1,h.s.deselect=!1}i(this.dom.panes).empty();b=0;for(c=this.s.panes;b<c.length;b++)h=c[b],h.s.lastSelect?h._setListeners():h.rebuildPane(void 0,
this.s.dt.page.info().serverSide?this.s.serverData:void 0,h.s.index===d?!0:null,!0),i(this.dom.panes).append(h.dom.container),void 0!==h.s.dtPane&&(i(h.s.dtPane.table().node()).parent()[0].scrollTop=h.s.scrollTop,i.fn.dataTable.select.init(h.s.dtPane));this.s.dt.page.info().serverSide||this.s.dt.draw()};k.prototype._startup=function(a){var b=this;i(this.dom.container).text("");this._attachExtras();i(this.dom.container).append(this.dom.panes);i(this.dom.panes).empty();var d=this.s.dt.state.loaded();
if(this.c.viewTotal&&!this.c.cascadePanes&&null!==d&&void 0!==d&&void 0!==d.searchPanes&&void 0!==d.searchPanes.panes){for(var c=!1,f=0,h=d.searchPanes.panes;f<h.length;f++){var e=h[f];if(0<e.selected.length){c=!0;break}}if(c){c=0;for(f=this.s.panes;c<f.length;c++)e=f[c],e.s.showFiltered=!0}}c=0;for(f=this.s.panes;c<f.length;c++)e=f[c],e.rebuildPane(void 0,0<Object.keys(this.s.serverData).length?this.s.serverData:void 0),i(this.dom.panes).append(e.dom.container);this.s.dt.page.info().serverSide||
